...
- Local (recommended):
  - Preview (dry-run): `python3 scripts/quality_loop.py --plan docs/FIX_PLAN.md --dry-run`
  - Apply commits locally (no push): `python3 scripts/quality_loop.py --plan docs/FIX_PLAN.md --apply --no-push`
...
- From a client (Claude / Copilot / Gemini):
  ...
  - Then run the workflow command shown by your client, for example: `/skills quality-loop --plan docs/FIX_PLAN.md --dry-run`
